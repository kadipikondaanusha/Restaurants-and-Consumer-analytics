...
from ratings where Overall_Rating = 2; 
...
select r.Name, r.City 
from restaurants r join restaurent_cuisine rc 
on r.Restaurant_ID = rc.Restaurant_ID
where rc.Cuisine = 'Pizzeria' and r.City in 
(select City from consumers where 
Occupation = 'Student'); 
...
select c.Consumer_ID, c.Age, r.Name from consumers c join ratings ra on c.Consumer_ID = ra.Consumer_ID
join;
